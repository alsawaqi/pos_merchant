...
return [
    ...
    'rate_limits' => [
        ...
        'two_factor_per_minute' => (int) env('POS_MERCHANT_TWO_FACTOR_RATE_LIMIT_PER_MINUTE', 5),
    ],

    // Phase D8 — TOTP two-factor auth tunables.
    'two_factor' => [
        // Issuer label shown in the authenticator app entry.
        'issuer' => env('POS_MERCHANT_TWO_FACTOR_ISSUER', 'MITHQAL Merchant'),
        // How long the password-passed-awaiting-code state stays
        // valid before the user must restart from /login.
        'challenge_ttl_minutes' => (int) env('POS_MERCHANT_TWO_FACTOR_CHALLENGE_TTL_MINUTES', 5),
    ],
];
