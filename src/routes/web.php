...
Route::middleware([EnsureUserIsAuthenticated::class, EnsureMerchantSessionIsFresh::class])->group(function (): void {
    ...
    Route::prefix('api')->middleware(RequireJsonRequest::class)->group(function (): void {
        ...
        Route::get('loyalty/shortfalls', [LoyaltyController::class, 'shortfallReviews'])
            ->name('loyalty.shortfalls.index');
        Route::post('loyalty/shortfalls/{transaction:uuid}/resolve', [LoyaltyController::class, 'resolveShortfall'])
            ->name('loyalty.shortfalls.resolve');
